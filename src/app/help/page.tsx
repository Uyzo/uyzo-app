        ...
        <div className="rounded-2xl border-2 border-brand bg-brand-light/40 p-4">
          ...
          <div className="mt-3 rounded-xl bg-white p-3 text-sm text-slate-700">
            ...
            <ol className="mt-1 list-decimal space-y-1 pl-5">
              <li>Нажмите <b>«Разместить»</b> вверху.</li>
              <li>Выберите раздел (недвижимость / товар) и тип сделки.</li>
              <li>Внизу нажмите <b>«Фотографии»</b> и загрузите снимки объекта.</li>
              <li>Нажмите фиолетовую кнопку <b>«✨ Заполнить автоматически»</b>.</li>
              <li>AI подставит заголовок, описание и цену — проверьте и при желании поправьте.</li>
              <li>Нажмите <b>«Опубликовать»</b>. Объявление уйдёт на быструю проверку и появится в ленте.</li>
            </ol>
          </div>
        </div>
